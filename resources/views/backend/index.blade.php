...
@section('icerik')
    ...
    <div class="right_col" role="main">
        ...
        <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                <span class="count_top"><i class="fa fa-edit"></i> Blogs</span>
                <div class="count">{{count(\App\Blog::all())}}</div>
                <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                <span class="count_top"><i class="fa fa-shopping-basket"></i> Products</span>
                <div class="count">{{count(\App\Product::all())}}</div>
                <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                <span class="count_top"><i class="fa fa-list-alt"></i> Total Orders</span>
                <div class="count green">{{count(\App\Order::all())}}</div>
                            ...
                            <div class="x_content">
                                <div class="dashboard-widget-content">
                                    ...
                                    <div id="world-map-gdp" class="col-md-8 col-sm-12 col-xs-12"
                                         style="height:230px;">
                                        <svg width="453" height="230">
                                            <g transform="scale(0.41818181818181815) translate(66.63043478260873, 3.39824786667874e-14)">
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    original="#6bbfad" id="jqvmap1_mx" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    original="#bee2da" id="jqvmap1_mr" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-opacity="0.25" fill="#8ccdbf"
                                                    original="#8ccdbf" id="jqvmap1_eg" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    original="#82c9ba" id="jqvmap1_za" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    original="#66bdab" id="jqvmap1_au" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    original="#38aa91" id="jqvmap1_cn" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
                                                    ...
                                                    original="#7ec7b8" id="jqvmap1_tw" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    original="#61bba8" id="jqvmap1_ru" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
                                                    ...
                                                    original="#149b7e" id="jqvmap1_us" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    original="#60baa7" id="jqvmap1_ca" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-opacity="0.25" fill="#82c9ba"
                                                    original="#82c9ba" id="jqvmap1_ar" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    original="#62bba8" id="jqvmap1_in" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-opacity="0.25" fill="#a7d8ce"
                                                    original="#a7d8ce" id="jqvmap1_mm" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-opacity="0.25" fill="#7ec7b8"
                                                    original="#7ec7b8" id="jqvmap1_sa" class="jqvmap-region"
                                                    fill-opacity="1"></path>
                                                <path
