...
@section('icerik')
    ...
    <title>Admin Panel | Banners page</title>
    ...
    <div class="right_col" role="main">
        <div class="">
            <div class="page-title">
                <div class="title">
                    <h3 style="float:left;">Banners page &nbsp; </h3>
                                    ...
                                    <div class="thumbnail">
                                        <div class="image view view-first">
                                            <img style="width: 100%; display: block;"
                                                 src="/uploads/img/Banners/{{$banner->image}}"
                                                 alt="{{$banner->title}}"/>
                                            <div class="mask no-caption">
                                                <div class="tools tools-bottom">
                                                    <a href="{{route('updateBanner',['banner'=>$banner->slug])}}"><i
