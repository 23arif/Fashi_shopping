...
@section('icerik')
    ...
    <title>Admin Panel | Add Slider</title>
    ...
    <div class="right_col" role="main">
        <div class="">
            <div class="page-title">
                <div class="title">
                    <h3 style="float:left;">Add Slider</h3>
                </div>
            </div>
            <div class="row">
...
{{--                                </div>--}}
                                <div class="form-group">
                                    <label for="sliderImage"
                                           class="control-label col-md-3 col-sm-3 col-xs-12">Add image *
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="desc"
                                               class="form-control col-md-6 col-sm-6 col-xs-12" name="description">
                                    </div>
                                </div>
